...
void stable_set_METHOD(int value)
{
	METHOD = value;
}
...
void stable_set_METHOD2(int value)
{
	METHOD2 = value;
}
...
void stable_set_METHOD3(int value)
{
	METHOD3 = value;
}
...
void stable_set_IT_MAX(unsigned int value)
{
	IT_MAX = value;
}
...
void stable_set_INV_MAXITER(unsigned int value)
{
	INV_MAXITER = value;
}
...
void stable_set_ALFA_TH(double value)
{
	ALFA_TH = value;
}
...
void stable_set_BETA_TH(double value)
{
	BETA_TH = value;
}
...
void stable_set_XXI_TH(double value)
{
	XXI_TH = value;
}
...
void stable_set_THETA_TH(double value)
{
	THETA_TH = value;
}
...
void stable_free(StableDist *dist)
{
	...
	stable_set_mixture_components(dist, 0);

	if (dist->mixture_weights)
		free(dist->mixture_weights);

	if (dist->mixture_components)
		free(dist->mixture_components);
