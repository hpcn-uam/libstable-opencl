...
DEBUG_CFLAGS = -ggdb -DSTABLE_MIN_LOG=0 -DDEBUG -fno-omit-frame-pointer -fsanitize=address
...
TARGETS = example fittest stable_array \
			...
			gen_randoms mixtures param_behaviour stable_plot_mixture \
			libtest mcmc_diagnostic_onecomp stdist
INCLUDES = -I./includes/
